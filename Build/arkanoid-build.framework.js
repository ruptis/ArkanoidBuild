...
var ASM_CONSTS = {
  12949072: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 12949127: ($0) => { performance.now = function() { return $0; }; },  
 12949175: ($0) => { performance.now = function() { return $0; }; },  
 12949223: () => { performance.now = Module['emscripten_get_now_backup']; }
};
